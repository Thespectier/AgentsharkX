...
When the document is hidden, the ambient grid and LiveFlow particles are
explicitly paused while the bounded SSE stream continues synchronization. On
return, the latest deduplicated data is rendered.
