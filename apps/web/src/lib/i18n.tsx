...
const zhCN: Record<string, string> = {
  ...
  "Not verified": "未验证",
  "Still running": "仍在运行",
  "Trace visualization": "追踪可视化",
  "Trace view": "追踪视图",
  Flow: "关系流",
  Timeline: "时间线",
  "Every bar uses the same absolute time baseline. Tree depth comes only from explicit parent_span_id relationships.":
    "所有时间条共用同一个绝对时间基线；树深度仅来自明确的 parent_span_id 关系。",
  "Switch between the explicit relationship flow and the absolute-time execution timeline.":
    "在明确关系流与绝对时间执行时间线之间切换。",
  "Span type filters": "Span 类型筛选",
  All: "全部",
  "Local tool": "本地工具",
  A2A: "A2A",
  Retriever: "检索器",
  "Toggle {type} spans": "切换{type} Span",
  "{visible} of {total} spans": "显示 {visible} / {total} 个 Span",
  "Errors only": "仅错误",
  "Timeline zoom": "时间线缩放",
  "Fit timeline": "适应时间线",
  "{zoom}× zoom": "{zoom}× 缩放",
  ...
  "Span / component": "Span / 组件",
  "Type · target · duration": "类型 · 目标 · 持续时间",
  "Detached spans": "游离 Span",
  "Missing or invalid parent relationship": "父级关系缺失或无效",
  "Expand {name}": "展开 {name}",
  "Collapse {name}": "折叠 {name}",
  "Expand subtree": "展开子树",
  "Collapse subtree": "折叠子树",
  "Open timeline bar for {name}": "打开 {name} 的时间条",
  "Clock skew": "时钟偏移",
  "No spans match the current visualization filters.": "没有 Span 符合当前可视化筛选条件。",
  "{count} tokens": "{count} Token",
  "Status unset": "状态未设置",
  "{count} subtrees collapsed": "已折叠 {count} 个子树",
  "Trace data diagnostics": "追踪数据诊断",
  "clock skew": "时钟偏移",
  "duplicate Span ID": "重复 Span ID",
  "duration mismatch": "持续时间不一致",
  "invalid timestamp": "时间戳无效",
  "missing parent": "父 Span 缺失",
  "missing root": "根 Span 缺失",
  "parent cycle": "父子关系成环",
  "root has a parent": "根 Span 存在父级",
  TraceFlow: "TraceFlow",
