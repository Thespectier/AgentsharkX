...
const zhCN: Record<string, string> = {
  ...
  Configured: "已配置",
  "Ambient / none": "运行环境 / 无",
  "Only verified base settings are written. Existing credentials can be preserved without exposing their value.":
    "仅写入已验证的基础设置；可保留现有凭据而不暴露其值。",
  "Provider name": "提供商名称",
  "Provider type": "提供商类型",
  "Default model": "默认模型",
  "Base URL": "基础 URL",
